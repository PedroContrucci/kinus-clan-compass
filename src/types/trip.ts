...
export const FLIGHT_DURATION: Record<string, number> = {
  ...
  'São Paulo-Bangkok': 22,
  'São Paulo-Phuket': 22,
  'São Paulo-Singapura': 20,
  'São Paulo-Seul': 26,
  'São Paulo-Kyoto': 25,
  'São Paulo-Auckland': 22,
  'São Paulo-Cidade do Cabo': 11,
  'São Paulo-Cairo': 15,
  'São Paulo-Istambul': 14,
  'São Paulo-Atenas': 14,
  'São Paulo-Praga': 13,
  'São Paulo-Berlim': 13,
  'São Paulo-Madri': 10.5,
  'São Paulo-Toronto': 11,
  'São Paulo-Los Angeles': 13,
