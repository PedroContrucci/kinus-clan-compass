...
const fortalezaActivities: SuggestedActivity[] = [
  ...
  {
    id: 'for-barraca-marulho',
    name: 'Barraca Marulho (Praia do Futuro)',
    category: 'lunch',
    neighborhood: 'Praia do Futuro',
    rating: 4.5,
    estimatedCostBRL: 90,
    durationHours: 2,
    tips: ['Estrutura ótima e atendimento elogiado por locais', 'Peixe à Delícia é o destaque', 'Alternativa autêntica às barracas mais turísticas'],
    styleTags: ['gastronomy', 'beach'],
  },
  {
    id: 'for-beira-mar',
