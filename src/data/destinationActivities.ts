...
const fortalezaActivities: SuggestedActivity[] = [
  ...
  },
  {
    ...
    estimatedCostBRL: 120,
    durationHours: 2,
    tips: ['A casa-mãe da rede que nasceu em Fortaleza — frutos do mar em pratos fartos', 'Pratos servem 2-3 pessoas: peçam menos do que o instinto manda'],
    styleTags: ['gastronomy'],
  },
  {
    id: 'for-rest-cabana-del-primo',
    name: 'Cabaña del Primo',
    category: 'dinner',
    neighborhood: 'Meireles',
    rating: 4.7,
    estimatedCostBRL: 140,
    durationHours: 2,
    tips: ['Parrilla uruguaia referência da cidade — ojo de bife e provoleta obrigatórios', 'Fila real em fim de semana: chegue cedo ou reserve'],
    styleTags: ['gastronomy'],
  },
  {
    id: 'for-rest-santa-grelha',
    name: 'Santa Grelha',
    category: 'dinner',
    neighborhood: 'Aldeota',
    rating: 4.7,
    estimatedCostBRL: 150,
    durationHours: 2,
    tips: ['Carnes premium e ambiente de ocasião — o jantar de fechamento da viagem'],
    styleTags: ['gastronomy'],
  },
  {
    id: 'for-rest-moleskine',
    ...
    estimatedCostBRL: 110,
    durationHours: 2,
    tips: ['Cozinha autoral e coquetelaria no coração da Varjota'],
    styleTags: ['gastronomy', 'nightlife'],
  },
  {
    id: 'for-rest-geppos',
    ...
    estimatedCostBRL: 120,
    durationHours: 2,
    tips: ['Tradição de décadas — massas e frutos do mar na Av. Desembargador Moreira'],
    styleTags: ['gastronomy'],
  },
  {
    id: 'for-rest-mercado-peixes',
    name: 'Mercado dos Peixes do Mucuripe',
    category: 'lunch',
    neighborhood: 'Mucuripe',
    rating: 4.5,
    estimatedCostBRL: 70,
    durationHours: 2,
    tips: ['Compre o peixe na banca e as barracas preparam na hora — a experiência mais autêntica da cidade', 'Vá cedo, de preferência em dia de semana'],
    styleTags: ['gastronomy', 'culture'],
  },
  {
    id: 'for-rest-chico-aldeota',
    ...
    estimatedCostBRL: 90,
    durationHours: 2,
    tips: ['A instituição do caranguejo em versão urbana — pra quem não pega a quinta na praia'],
    styleTags: ['gastronomy', 'culture'],
  },
  {
    id: 'for-rest-ryori',
    ...
    estimatedCostBRL: 130,
    durationHours: 2,
    tips: ['Referência japonesa da cidade — unidade do Shopping Buganvília (Av. Dom Luís)'],
    styleTags: ['gastronomy'],
  },
  {
    id: 'for-rest-lo',
    ...
    estimatedCostBRL: 160,
    durationHours: 2,
    tips: ['Franco-contemporâneo na Av. Pessoa Anta — o fine dining do Centro histórico'],
    styleTags: ['gastronomy'],
  },
  {
    id: 'for-rest-vasto',
    ...
    estimatedCostBRL: 130,
    durationHours: 2,
    tips: ['Carnes e cozinha contemporânea na Senador Virgílio Távora'],
    styleTags: ['gastronomy'],
  },
  {
    id: 'for-rest-boteco-praia',
    name: 'Boteco Praia',
    category: 'dinner',
    neighborhood: 'Meireles',
    rating: 4.5,
    estimatedCostBRL: 70,
    durationHours: 2,
    tips: ['O happy-hour clássico de frente pro mar — caldinho, petiscos e fim de tarde cearense'],
    styleTags: ['gastronomy', 'nightlife'],
  },
  {
    id: 'for-doce-50-sabores',
    ...
    estimatedCostBRL: 30,
    durationHours: 1,
    tips: ['A sorveteria símbolo da cidade — prove os sabores regionais: cajá, seriguela, tapioca'],
    styleTags: ['gastronomy', 'relaxation'],
  },
  {
    id: 'for-barraca-chico-praia',
    ...
    estimatedCostBRL: 85,
    durationHours: 5,
    tips: ['🌊 Tem parque aquático com piscina e brinquedos — ótimo para famílias com crianças (info dos curadores locais)', 'Quinta-feira é o dia da caranguejada mais famosa do Brasil — música e mesa farta', 'Nos demais dias, praia tranquila com cozinha forte'],
    styleTags: ['relaxation', 'gastronomy', 'culture'],
  },
  {
    ...
    estimatedCostBRL: 85,
    durationHours: 5,
    tips: ['🌊 Tem parque aquático — vibe família confirmada pelos curadores locais', 'Boa estrutura para passar o dia inteiro com crianças'],
    styleTags: ['relaxation', 'gastronomy'],
  },
  {
    id: 'for-barraca-crocobeach',
    ...
    estimatedCostBRL: 110,
    durationHours: 5,
    tips: ['Uma das maiores estruturas da orla — coquetéis, frutos do mar e grelhados entre palmeiras', 'Acessibilidade completa (entrada, assentos, banheiro e estacionamento adaptados)', 'Consumo médio R$ 60-160 por pessoa; chegue antes das 10h em alta temporada'],
    styleTags: ['relaxation', 'gastronomy'],
  },
  {
    id: 'for-barraca-itaparika',
    ...
    estimatedCostBRL: 80,
    durationHours: 5,
    tips: ['Atmosfera familiar com pacote completo para crianças: cardápio infantil, cadeirinhas e fraldário', 'Música ao vivo, mesas na cobertura e acessibilidade completa', 'Consumo médio R$ 40-160 por pessoa'],
    styleTags: ['relaxation', 'gastronomy'],
  },
  {
    ...
    estimatedCostBRL: 100,
    durationHours: 5,
    tips: ['DJ, festa e público jovem — o lado agito da Praia do Futuro', 'Melhor para grupos de amigos do que para famílias com crianças pequenas'],
    styleTags: ['relaxation', 'nightlife'],
  },
  {
    id: 'for-barraca-santa-praia',
    ...
    estimatedCostBRL: 85,
    durationHours: 5,
    tips: ['Estrutura moderna com eventos e boa cozinha — meio-termo entre família e agito'],
    styleTags: ['relaxation', 'gastronomy'],
  },
];
