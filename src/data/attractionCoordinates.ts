...
export const ATTRACTION_COORDS: Record<string, { lat: number; lng: number }> = {
  ...
  // ─── Fortaleza ───
  'praia do futuro, fortaleza': { lat: -3.7556, lng: -38.4636 },
  'barraca marulho, fortaleza': { lat: -3.7470, lng: -38.4530 },
  'parque do cocó, fortaleza': { lat: -3.7480, lng: -38.4810 },
  'mercado central de fortaleza, fortaleza': { lat: -3.7280, lng: -38.5270 },
  'mercado central, fortaleza': { lat: -3.7280, lng: -38.5270 },
  'praia do cumbuco, fortaleza': { lat: -3.6280, lng: -38.7330 },
  'cumbuco, fortaleza': { lat: -3.6280, lng: -38.7330 },
  'mercado dos peixes, fortaleza': { lat: -3.7160, lng: -38.4790 },
  'mercado dos peixes (mucuripe), fortaleza': { lat: -3.7160, lng: -38.4790 },
  'varjota, fortaleza': { lat: -3.7390, lng: -38.4920 },
  'calçadão da beira-mar, fortaleza': { lat: -3.7250, lng: -38.4910 },
  'beira-mar, fortaleza': { lat: -3.7250, lng: -38.4910 },
  'ceart, fortaleza': { lat: -3.7400, lng: -38.4990 },
  'theatro josé de alencar, fortaleza': { lat: -3.7290, lng: -38.5260 },
  'beach park, fortaleza': { lat: -3.8330, lng: -38.4360 },
  'praia da taíba, fortaleza': { lat: -3.5180, lng: -38.9180 },
  'praia de águas belas, fortaleza': { lat: -4.0850, lng: -38.2360 },
  'carneiro do ordones (varjota), fortaleza': { lat: -3.7390, lng: -38.4920 },
  'carneiro do ordones, fortaleza': { lat: -3.7390, lng: -38.4920 },
  'caranguejada de quinta (iate clube), fortaleza': { lat: -3.7090, lng: -38.4760 },
  'centro dragão do mar de arte e cultura, fortaleza': { lat: -3.7210, lng: -38.5170 },
  'dragão do mar, fortaleza': { lat: -3.7210, lng: -38.5170 },
  'estação das artes, fortaleza': { lat: -3.7270, lng: -38.5290 },
  'praia de iracema e ponte dos ingleses, fortaleza': { lat: -3.7180, lng: -38.5130 },
  'praia de iracema, fortaleza': { lat: -3.7180, lng: -38.5130 },
  'tapioqueiras, fortaleza': { lat: -3.8190, lng: -38.4640 },
