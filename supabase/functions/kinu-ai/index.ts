  ...
  try {
    ...
    if (body.context && typeof body.context === "object") {
      ...
      if (parts.length > 0) {
        ...
        // origem existe porque KinuTripContext não tem campo de cidade de partida —
        // e o agente já inventou uma ("saindo de São Paulo") na ausência do aviso.
        // Reforço, não defesa: sem viagem ativa este bloco nem é emitido, e a
        // proibição incondicional vive no system prompt, que vai em 100% das chamadas.
        contextStr =
